...
import { BillboardHeaderProps, PopoverTitleProps, PopoverContentProps } from "@/interfaces/boards";
import {
  BillboardHeaderCss,
  BillboardHeaderBtn,
  PopoverTitleStyle,
...
const PopoverTitle: React.FC<PopoverTitleProps> = (props) => {
  const { isMenu, isUser, isSetting, setIsMenu, setOpenPopover, setIsUser, setIsSetting } = props;
  const handleClick = () => {
      ...
      {isUser ?
        <>
          ...
          <Button
            ...
            icon={
              <LeftOutlined style={{ color: "var(--gray66)", fontSize: "16px" }} />
            }
...
const PopoverContent: React.FC<PopoverContentProps> = (props) => {
  const { name, member, isUser, isMenu, isSetting, setIsUser, setIsMenu, setIsSetting } = props;
          ...
          {member &&
            member?.map((ele, idx) => (
              <div style={{ display: "flex" }} key={idx}>
                ...
                <p style={{ marginTop: "5px", marginLeft: "5px" }}>{ele.userId.name}</p>
              </div>
            ))}
        </div> : null
      }
        ...
        <>
          <div className="top-border">
            <Button
              ...
              style={{ width: "100%", textAlign: "left", padding: "0 12px", height: "64px", lineHeight: "32px" }}
            >
              變更工作區...
              <p style={{ fontSize: "12px", marginTop: "-10px", marginLeft: "2px", color: "gray" }}>{name}</p>
            </Button>
          </div>
          <div className="top-border">
            <Button
            ...
            >
              評論權限...
              <p style={{ fontSize: "12px", marginTop: "-10px", marginLeft: "2px", color: "gray" }}>{people}</p>
            </Button>
          </div>
          {isShowChangeWorkSpace ?
            <div className="peopleView">
              ...
              <div className="peopleContent">
                ...
                >
                  工作區成員
                  <p style={{ fontSize: "12px", marginTop: "-10px", marginLeft: "2px", color: "gray" }}>此工作區的所有成員皆可發表評論</p>
                </Button>
              </div>
            </div> : null
          }
          {isShowChangePeople ?
            <div className="peopleView">
              ...
              <div className="peopleContent">
                ...
                >
                  Disabled
                  <p style={{ fontSize: "12px", marginTop: "-10px", marginLeft: "2px", color: "gray" }}>沒有人可以發表評論</p>
                </Button>
                <Button
                  type="text"
                  onClick={PeopleClick}
                ...
                >
                  成員
                  <p style={{ fontSize: "12px", marginTop: "-10px", marginLeft: "2px", color: "gray" }}>管理員及成員可以發表評論</p>
                </Button>
                <Button
                  type="text"
                  onClick={PeopleClick}
    ...
    <BillboardHeaderCss className="d-space">
      ...
      <div className="right-head">
        ...
        <Popover
          ...
          arrow={false}
          title={<PopoverTitle isMenu={isMenu} isUser={isUser} isSetting={isSetting} setIsMenu={setIsMenu} setOpenPopover={setOpenPopover} setIsUser={setIsUser} setIsSetting={setIsSetting} />}
          content={<PopoverContent name={name} member={member} isUser={isUser} isMenu={isMenu} isSetting={isSetting} setIsUser={setIsUser} setIsMenu={setIsMenu} setIsSetting={setIsSetting} />}
          trigger="click"
          open={openPopover}
          onOpenChange={(e) => {
            setOpenPopover(e);
